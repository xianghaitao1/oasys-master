 ...
 /**
   ...
   */
	...
	public Map<String,Object> index3(String name,User user,String typename,ProcessList process){
		...
		result.put("legal",process.getLegal());
		result.put("phonenum1",process.getPhonenum1());
		result.put("entnature",process.getEntnature());
	 ...
	 */
	public void index5(ProcessList pro,String val,User lu,String name) throws IllegalStateException, IOException{
